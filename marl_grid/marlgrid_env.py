...
from marl_grid.constants import COLOR_NAMES, DIR_TO_VEC, TILE_PIXELS
from marl_grid.grid import Grid
from marl_grid.world_object import Point, WorldObj
...
class MARLGridEnv(gym.Env):
    ...
    def reset(
        ...
        *,
        ...
        # Return first observation TODO -> our setting we should see the whole grid?
        obs = self.gen_obs()
